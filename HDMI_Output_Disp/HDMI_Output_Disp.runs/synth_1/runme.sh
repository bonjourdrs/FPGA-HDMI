...
HD_PWD='E:/lab_work/4k/HDMI_Output_Disp/HDMI_Output_Disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_Output_Disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_Output_Disp.tcl
