...
HD_PWD='E:/lab_work/4k/HDMI_Output_Disp/HDMI_Output_Disp.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_Output_Disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_Output_Disp.tcl -notrace
