...
HD_PWD='E:/lab_work/4k/HDMI_Output_Disp/HDMI_Output_Disp.runs/hdmi_disp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_disp.tcl
